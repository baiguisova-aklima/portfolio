export const GAME_TEXT = {
  ...
  scenes: [
    ...
    { label: 'DLC', title: 'THAILAND', objective: 'Садись на байк.' },
    { label: 'LEVEL 05', title: 'BARCELONA', objective: 'Познакомься с новыми членами party.' },
    { label: 'LEVEL 06', title: 'THE HARD QUEST', objective: 'Поддержи Аклиму.' },
    { label: 'LEVEL 07', title: 'WEDDING', objective: 'Подойди к арке.' },
    { label: 'LEVEL 08', title: 'HOME BASE', objective: 'Осмотрись и садись рядом с Аклимой.' },
  ],
  finalStats: [
...
export const OBJECTIVES: readonly (readonly string[])[] = [
  ['Подойди к цветку справа. Высыпь землю 3 раза — 0/3.', 'Снова высыпь землю из цветка — 1/3.', 'Высыпь землю из цветка ещё раз — 2/3.', 'Земля: 3/3. Подойди к компьютеру слева и начни кодить.', 'Подойди к двери EXIT справа и выйди с завода.'],
...
export const DIALOG = {
  ...
  note: ['Несколько дней спустя…', 'Алексей переворачивает горшок.', 'На дне записка:', '«ПОШЁЛ НАХУЙ»', 'ACHIEVEMENT UNLOCKED: FAFO'],
